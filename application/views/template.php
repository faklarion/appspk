    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">                          
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <?php if(($this->session->userdata('images') === NULL) || ($this->session->userdata('images') === '')) { ?>
                                            <img src="<?php echo base_url() ?>assets/foto_profil/ppkosong.jpg" class="user-image" alt="User Image">
                                        <?php } else { ?>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        <?php if(($this->session->userdata('images') === NULL) || ($this->session->userdata('images') === '')) { ?>
                                            <img src="<?php echo base_url() ?>assets/foto_profil/ppkosong.jpg" class="img-circle" alt="User Image">
                                        <?php } else { ?>
        ...
        <script>
         ...
         <!-- Modal -->
            ...
            <h4 class="modal-title">SHIELD HUMAN PROJECT</h4>
            </div>
            <!-- body modal -->
            <div class="modal-body">
            <table class="table table-striped">
                <tr>
                    <td><i class="fa fa-whatsapp" aria-hidden="true"><a href="https://wa.me/6282154619823/" target="_blank"> Whatsapp 1</a></i></td>
                </tr>
                <tr>
                    <td><i class="fa fa-whatsapp" aria-hidden="true"><a href="https://wa.me/6281260023839/" target="_blank"> Whatsapp 2</a></i></td>
                </tr>
            </table>
            </div>
            <!-- footer modal -->
