	...
	<section class="content">
		...
		<table class='table table-bordered'>        
			...
			<tr>
				...
				<td>
					<?php 
                    $listSub = $this->Tbl_sub_banjarmasin_model->get_total_dpp_sub($id_sub_banjarmasin);
			...
			<tr>
				<td></td>
				<td><a href="<?php echo site_url('tbl_spk_banjarmasin') ?>" class="btn btn-default">Kembali</a></td>
			</tr>
