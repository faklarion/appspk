...
<div class="content-wrapper">
    <section class="content">
            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA PROSES PERKERJAAN BANJARMASIN</h3>
                    </div>
        ...
        <!-- <?php echo anchor(site_url('tbl_sub_banjarmasin/create_proses'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data Proses', 'class="btn btn-danger btn-sm"'); ?> -->
		<?php echo anchor(site_url('tbl_sub_banjarmasin/word'), '<i class="fa fa-file-word-o" aria-hidden="true"></i> Export Ms Word', 'class="btn btn-primary btn-sm"'); ?></div>
            </div>
            <div class='col-md-3'>
			...
			<td style="text-align:center" width="200px">
				<?php 
                 if($this->session->userdata('id_user_level') != 7) {
                    echo anchor(site_url('tbl_sub_banjarmasin/update_pekerjaan_new/'.$tbl_sub_banjarmasin->id_sub_banjarmasin),'<i class="fa fa-edit" aria-hidden="true"> Update Pekerjaan</i>','class="btn btn-danger btn-sm"'); 
                    echo '  '; 
                 }
                ?>
			</td>
