				...
				<table class='table table-bordered'>
					...
					<tr>
						...
						<td>
							...
							<a href="<?php echo site_url('tbl_sub_banjarmasin/home_vic') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
