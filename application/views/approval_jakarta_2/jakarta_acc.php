...
<div class="content-wrapper">
    <section class="content">
            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA DISETUJUI KASIR JAKARTA</h3>
                    </div>
            ...
            <div class="col-md-12 text-center">
                <div style="margin-top: 8px" id="message">
                   <table class="table table-bordered">
                        <tr>
                            <td>
                            <form method="get" action="<?php echo site_url('tbl_sub_jakarta/cari_tanggal_acc_kasir') ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <a href="<?php echo site_url('tbl_sub_jakarta/home_acc_kasir') ?>" class="btn btn-warning">RESET</a> 
                                            </div>
        ...
        <table class="table table-bordered sortable table_wrapper" style="margin-bottom: 10px" id="dataTable">
            ...
            ?></td>
            <td><?php echo tgl_indo($tbl_sub_jakarta->tgl_persetujuan_1) ?></td>
            <td><?php echo tgl_indo($tbl_sub_jakarta->tgl_persetujuan_2) ?></td>
			<td style="text-align:center" width="200px">
				<?php 
                if($this->session->userdata('id_user_level') != 7) {
                    echo anchor(site_url('tbl_sub_jakarta/cetak_kasir/'.$tbl_sub_jakarta->id_waiting_jakarta),'<i class="fa fa-print" aria-hidden="true"></i>','class="btn btn-danger btn-sm"'); 
                    echo '  '; 
                }
                
                if($this->session->userdata('id_user_level') == 6) {
                echo anchor(site_url('tbl_sub_jakarta/batal_kasir/'.$tbl_sub_jakarta->id_waiting_jakarta),'<i class="fa fa-close" aria-hidden="true"></i>','class="btn btn-danger btn-sm"');  
                echo '  '; 
