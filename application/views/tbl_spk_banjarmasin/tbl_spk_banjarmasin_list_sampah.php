            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">SAMPAH INDUK SPK BANJARMASIN</h3>
                    </div>
        ...
        <table class="table table-bordered table_wrapper sortable" style="margin-bottom: 10px" id="dataTable">
            ...
            <td style="text-align:center" width="200px">
                ...
                if($this->session->userdata('id_user_level') == 6) {
				    echo anchor(site_url('tbl_spk_banjarmasin/restore_sampah/'.$tbl_spk_banjarmasin->id_spk_banjarmasin),'<i class="fa fa-recycle" aria-hidden="true"></i>','class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                    echo ' ';
                    echo anchor(site_url('tbl_spk_banjarmasin/delete/'.$tbl_spk_banjarmasin->id_spk_banjarmasin),'<i class="fa fa-trash-o" aria-hidden="true"></i>','class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                }
                ?>
			</td>
            <!-- <td>
