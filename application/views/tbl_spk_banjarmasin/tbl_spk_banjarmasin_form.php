	...
	<section class="content">
		<div class="box box-warning box-solid">
			<div class="box-header with-border">
				<h3 class="box-title"><?php echo strtoupper($button) ?> DATA INDUK SPK BANJARMASIN</h3>
			</div>
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered'>
					...
					<tr>
						<td></td>
						<td>
							<input type="hidden" name="id_spk_banjarmasin" value="<?php echo $id_spk_banjarmasin; ?>" /> 
