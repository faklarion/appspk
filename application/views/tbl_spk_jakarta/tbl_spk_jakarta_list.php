...
<div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA INDUK SPK JAKARTA</h3>
                    </div>
        ...
        echo anchor(site_url('tbl_spk_jakarta/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> TAMBAH INDUK', 'class="btn btn-danger btn-sm"'); 
         }
        ?>
        <?php 
         if(($this->session->userdata('id_user_level') != 7) && ($this->session->userdata('id_user_level') != 2)  && ($this->session->userdata('id_user_level') != 5) && ($this->session->userdata('id_user_level') != 3)) {
        echo anchor(site_url('tbl_sub_jakarta/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> TAMBAH SUB', 'class="btn btn-warning btn-sm"'); 
         }?>
		</div>
        </div>
            <div class='col-md-3'>
            ...
            <div class="col-md-12 text-center">
                <div style="margin-top: 8px" id="message" class="table-responsive">
                   <table class="table table-bordered">
                        <tr>
                            <td>
                                <form method="get" action="<?php echo site_url('tbl_spk_jakarta/word') ?>" target="_blank">
                            ...
                            <td>
                            <form method="get" action="<?php echo site_url('tbl_spk_jakarta/cari_vendor') ?>">
                                            <div class="form-group">
                                            FILTER VENDOR
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <a href="<?php echo site_url('tbl_spk_jakarta') ?>" class="btn btn-warning">RESET</a> 
                                            </div>
                            </form>
                            </td>
                            <td>
                            <form method="get" action="<?php echo site_url('tbl_spk_jakarta/cari_vic') ?>">
                                            <div class="form-group">
                                            FILTER VIC
                                            </div>
                                            <div class="form-group">
                            ...
                            <td>
                            <form method="get" action="<?php echo site_url('tbl_spk_jakarta/cari') ?>">
                                            <div class="form-group">
                                            FILTER PERIODE
                                            </div>
                                            <div class="form-group">
        ...
        <table class="table table-bordered table_wrapper sortable" style="margin-bottom: 10px" id="dataTable">
            ...
            <td><?php echo $tbl_spk_jakarta->nama_vic ?></td>
            ...
            <td>
                <?php 
                    $listPayment = $this->Tbl_sub_jakarta_model->get_total_payment_dpp($tbl_spk_jakarta->id_spk_jakarta);
            ...
            <td style="text-align:center" width="200px">
                ...
                <?php 
                 if(($this->session->userdata('id_user_level') != 7) && ($this->session->userdata('id_user_level') != 2)  && ($this->session->userdata('id_user_level') != 5) && ($this->session->userdata('id_user_level') != 3) && ($this->session->userdata('id_user_level') != 4)) {
                    echo '<p>';
                    echo anchor(site_url('tbl_spk_jakarta/update/'.$tbl_spk_jakarta->id_spk_jakarta),'<i class="fa fa-pencil-square-o" aria-hidden="true"></i>','class="btn btn-danger btn-sm"'); 
                    echo '  '; 
                 }
                if($this->session->userdata('id_user_level') == 6) {
				    echo anchor(site_url('tbl_spk_jakarta/delete_sampah/'.$tbl_spk_jakarta->id_spk_jakarta),'<i class="fa fa-trash-o" aria-hidden="true"></i>','class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                }
                ?>
			</td>
            <td>
            ...
            <tr>
                ...
                <th>
                    <?php  
                     $allPayment = $this->Tbl_sub_jakarta_model->get_total_payment_all();
...
foreach ($tbl_spk_jakarta_data as $row) : ?>
  ...
  <?php if($this->session->userdata('id_user_level') == 6) { ?>
        <div class="row">
		              <!--buttons-->
                    <div class="btn-float">
                        <a href="<?php echo site_url('tbl_spk_jakarta/sampah')?>"><button type="button" class="btn btn-danger btn-circle btn-xl"><i class="fa fa-trash"> </i></button><br><br></a>
