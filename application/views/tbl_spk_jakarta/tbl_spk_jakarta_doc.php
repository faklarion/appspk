    ...
    <body>
        ...
        <table class="word-table" style="margin-bottom: 10px">
            ...
            <th>No</th>
                ...
                <td width="20px"><?php echo $tbl_spk_jakarta->no_po ?></td>
                <td width="20px"><?php echo $tbl_spk_jakarta->nama_vic ?></td>
                <td width="30px"><?php echo $tbl_spk_jakarta->no_spk ?></td>
                <td width="30px"><?php echo tgl_indo($tbl_spk_jakarta->tgl_spk) ?></td>
                <td width="30px"><?php echo $tbl_spk_jakarta->pelaksana ?></td>
                <td width="30px"><?php echo $tbl_spk_jakarta->nama_vendor ?></td>
                <td width="30px"><?php echo $tbl_spk_jakarta->nama_kapal ?></td>
                <td width="30px">
                <?php 
            ...
            <td width="30px"><?php echo $tbl_spk_jakarta->full_name ?> - <?php echo $tbl_spk_jakarta->last_update ?> </td>
        </tr>
        </table>
        
        <?php 
        $idSpk = @$tbl_spk_jakarta->id_spk_jakarta;
        $listSub = $this->Tbl_sub_jakarta_model->get_by_id($idSpk); ?>
        ...
        <table class="word-table" style="margin-bottom: 10px; align: center">
			...
			<td><?php echo rupiah($tbl_sub_jakarta->dpp) ?></td>
            <td><?php 
            ...
            <td><?php echo $tbl_sub_jakarta->full_name ?> - <?php echo $tbl_sub_jakarta->last_update ?> </td>
