	...
	<section class="content">
		<div class="box box-warning box-solid">
			<div class="box-header with-border">
				<h3 class="box-title"><?php echo strtoupper($button) ?> DATA TBL_PEKERJAAN_BANJARMASIN</h3>
			</div>
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered'>
					...
					<tr>
						<td width='200'>Id Sub Banjarmasin <?php echo form_error('id_sub_banjarmasin') ?></td><td><input type="text" class="form-control" name="id_sub_banjarmasin" id="id_sub_banjarmasin" placeholder="Id Sub Banjarmasin" value="<?php echo $id_sub_banjarmasin; ?>" /></td>
					</tr>
					...
					<tr>
						<td></td>
						<td>
							<input type="hidden" name="id_pekerjaan_banjarmasin" value="<?php echo $id_pekerjaan_banjarmasin; ?>" /> 
							<button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
							<a href="<?php echo site_url('tbl_pekerjaan_banjarmasin') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
