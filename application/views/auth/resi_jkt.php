	...
	'<?php echo base_url('assets/images/gambarlogistik.jpg');?>')no-repeat;background-size:100%;">
        <div class="box">
            ...
            <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Cari No SPK.." class="form-control">
                <br>
            <?php 
          $listSub = $this->Tbl_pekerjaan_jakarta_model->get_all_kerja(); ?>
          <table class="table table-bordered" style="margin-bottom: 10px" id="dataTable">
			...
			<td style="text-align:center" width="200px">
				<button type="submit" class="btn btn-success" data-toggle="modal" data-target="#modal<?php echo $tbl_sub_jakarta->id_sub_jakarta ?>">
...
<?php
    $mulai = 0;
    foreach ($tbl_sub_jakarta_data as $tbl_sub_jakarta) : ?>
  <div class="modal fade" id="modal<?php echo $tbl_sub_jakarta->id_sub_jakarta ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <table class="table table-bordered" style="margin-bottom: 10px">
            ...
            $mulai = 0;
            $listSub = $this->Tbl_pekerjaan_jakarta_model->get_by_id_read($tbl_sub_jakarta->id_sub_jakarta);
