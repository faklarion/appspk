		...
		<div class="box box-primary">
			<div class="box-body box-profile">
                <?php if(($images == NULL) || ($images == '')) { ?>
                    <img class="profile-user-img img-responsive img-circle" src="<?= base_url('assets/foto_profil/ppkosong.jpg'); ?>" style="width:125px; height:125px">
                <?php } else { ?>
				...
				<div class="active tab-pane" id="settings">
					<form class="form-horizontal" action="<?php echo site_url('user/updateProfile') ?>" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" placeholder="Nama" name="full_name" value="<?= $full_name; ?>" required>
							</div>
						</div>
						<div class="form-group">
