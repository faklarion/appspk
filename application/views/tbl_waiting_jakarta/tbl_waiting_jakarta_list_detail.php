...
<div class="content-wrapper">
    <section class="content">
        ...
        <table class="table table-bordered sortable table_wrapper" style="margin-bottom: 10px" id="dataTable">
            ...
            $jumlahPermintaan += $tbl_waiting_jakarta->jumlah_permintaan; ?></td>
			<td><?php echo tgl_indo($tbl_waiting_jakarta->tgl_permintaan) ?></td>
            <td>
                <?php 
                if($tbl_waiting_jakarta->acc == 2) {
            ...
            <td>
                <?php 
                if($tbl_waiting_jakarta->tgl_persetujuan_2 == NULL) {
                    echo 'Belum Disetujui';
                } else {
                    echo $tbl_waiting_jakarta->tgl_persetujuan_2;
                }
                ?>
            </td>
			...
			<td style="text-align:center" width="200px">
                ...
                echo anchor(site_url('tbl_waiting_jakarta/update/'.$tbl_waiting_jakarta->id_waiting_jakarta),'<i class="fa fa-pencil-square-o" aria-hidden="true"></i>','class="btn btn-danger btn-sm"'); 
				echo '  ';
				echo anchor(site_url('tbl_waiting_jakarta/delete_sampah/'.$tbl_waiting_jakarta->id_waiting_jakarta),'<i class="fa fa-trash-o" aria-hidden="true"></i>','class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                }
                ?>
			</td>
		</tr>
