	...
	<section class="content">
		<div class="box box-warning box-solid">
			<div class="box-header with-border">
				<h3 class="box-title"><?php echo strtoupper($button) ?> DATA WAITING LIST JAKARTA</h3>
			</div>
				...
				<table class='table table-bordered'>
					...
					<tr>
						...
						<td>
							...
							<a href="<?php echo site_url('tbl_waiting_jakarta') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
