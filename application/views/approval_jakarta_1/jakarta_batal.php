...
<div class="content-wrapper">
    <section class="content">
            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA PEMBATALAN JAKARTA</h3>
                    </div>
        ...
        <table class="table table-bordered sortable table_wrapper" style="margin-bottom: 10px" id="dataTable">
            ...
            $totalNilai += $tbl_sub_jakarta->nilai_spk; ?></td>
            <td><?php echo $tbl_sub_jakarta->tgl_pembatalan_1 ?></td>
            ...
            <tr>
                ...
                <th></th>
                <th></th>
                <th><?php echo rupiah($totalNilai); ?></th>
                <th></th>
                <th></th>
            </tr>
            </tfoot>
