...
<div class="content-wrapper">
    <section class="content">
            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA DISETUJUI JAKARTA</h3>
                    </div>
        ...
        <table class="table table-bordered sortable table_wrapper" style="margin-bottom: 10px" id="dataTable">
            ...
            ?></td>
            <td><?php echo $tbl_sub_jakarta->tgl_persetujuan_1 ?></td>
			<td style="text-align:center" width="200px">
				<?php 
                 if($this->session->userdata('id_user_level') != 7) {
				echo anchor(site_url('tbl_sub_jakarta/batal/'.$tbl_sub_jakarta->id_waiting_jakarta),'<i class="fa fa-close" aria-hidden="true"></i>','class="btn btn-danger btn-sm"'); 
				echo '  '; 
                 }
