...
<div class="content-wrapper">
    <section class="content">
            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA DISETUJUI BANJARMASIN</h3>
                    </div>
        ...
        <table class="table table-bordered sortable table_wrapper" style="margin-bottom: 10px" id="dataTable">
            ...
            ?></td>
            <td><?php echo $tbl_sub_banjarmasin->tgl_persetujuan_1 ?></td>
			<td style="text-align:center" width="200px">
				<?php 
                 if($this->session->userdata('id_user_level') != 7) {
				echo anchor(site_url('tbl_sub_banjarmasin/batal/'.$tbl_sub_banjarmasin->id_waiting_banjarmasin),'<i class="fa fa-close" aria-hidden="true"></i>','class="btn btn-danger btn-sm"'); 
				echo '  '; 
                 }
                if($this->session->userdata('id_user_level') == 6) {
				echo anchor(site_url('tbl_sub_banjarmasin/delete_sampah/'.$tbl_sub_banjarmasin->id_waiting_banjarmasin),'<i class="fa fa-trash-o" aria-hidden="true"></i>','class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                }
                ?>
			</td>
		</tr>
