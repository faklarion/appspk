    ...
    <section class="content">
        ...
        <table class="table table-bordered sortable table_wrapper" style="margin-bottom: 10px" id="dataTable">
			...
			<td style="text-align:center" width="200px">
				...
				echo anchor(site_url('tbl_sub_banjarmasin/acc/'.$tbl_sub_banjarmasin->id_waiting_banjarmasin),'<i class="fa fa-check" aria-hidden="true"></i>','class="btn btn-danger btn-sm"'); 
				echo '  '; 
                 }
