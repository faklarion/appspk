	...
	<section class="content">
		<div class="box box-warning box-solid">
			<div class="box-header with-border">
				<h3 class="box-title">DETAIL DATA TBL_PEKERJAAN_JAKARTA</h3>
			</div>
		...
		<table class='table table-bordered'>        
			...
			<tr>
				<td>Id Sub Jakarta</td>
				<td><?php echo $id_sub_jakarta; ?></td>
			</tr>
			...
			<tr>
				<td></td>
				<td><a href="<?php echo site_url('tbl_pekerjaan_jakarta') ?>" class="btn btn-default">Kembali</a></td>
			</tr>
