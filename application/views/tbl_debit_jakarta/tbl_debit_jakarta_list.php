...
<div class="content-wrapper">
    <section class="content">
        ...
        <?php 
            if($this->session->userdata('id_user_level') != 7) {
            echo anchor(site_url('tbl_payment_jakarta/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Payment Debit', 'class="btn btn-danger btn-sm"'); 
            }
        ?>
...
<div class="row">
		              <!--buttons-->
                    <div class="btn-float">
                        <a href="<?php echo site_url('tbl_debit_jakarta/sampah')?>"><button type="button" class="btn btn-danger btn-circle btn-xl"><i class="fa fa-trash"> </i></button><br><br></a>
