            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                ...
                <table class='table table-bordered'>        
                    ...
                    if ($this->uri->segment(2) == 'create') {
                        ?>
                        <tr><td width='200'>Password <?php echo form_error('password') ?></td><td><input type="password" class="form-control" name="password" id="password" placeholder="Password" value="<?php echo $password; ?>" required /></td></tr>
                        <?php
                    } ?>
