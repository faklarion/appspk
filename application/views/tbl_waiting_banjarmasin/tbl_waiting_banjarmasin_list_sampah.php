            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">SAMPAH WAITING LIST BANJARMASIN</h3>
                    </div>
			...
			<td style="text-align:center" width="200px">
				<?php 
                 if(($this->session->userdata('id_user_level') != 7) && ($this->session->userdata('id_user_level') != 6) && ($this->session->userdata('id_user_level') != 2)) {
                    if($tbl_waiting_banjarmasin->acc == 0 ){
				echo anchor(site_url('tbl_waiting_banjarmasin/restore_sampah/'.$tbl_waiting_banjarmasin->id_waiting_banjarmasin),'<i class="fa fa-recycle" aria-hidden="true"></i>','class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				echo '  ';
                    }
                 }
                ...
                echo anchor(site_url('tbl_waiting_banjarmasin/restore_sampah/'.$tbl_waiting_banjarmasin->id_waiting_banjarmasin),'<i class="fa fa-recycle" aria-hidden="true"></i>','class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				echo '  ';
				echo anchor(site_url('tbl_waiting_banjarmasin/delete/'.$tbl_waiting_banjarmasin->id_waiting_banjarmasin),'<i class="fa fa-trash-o" aria-hidden="true"></i>','class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                }
                ?>
			</td>
		</tr>
