      ...
      <td><?php echo $tbl_debit_banjarmasin->deskripsi ?></td>
			...
			<td style="text-align:center" width="200px">
                ...
                if($this->session->userdata('id_user_level') == 6) {
                  ...
                  echo '  '; 
                  echo anchor(site_url('tbl_debit_banjarmasin/delete/'.$tbl_debit_banjarmasin->id_debit_banjarmasin),'<i class="fa fa-trash-o" aria-hidden="true"></i>','class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                  }
                ?>
			</td>
		</tr>
