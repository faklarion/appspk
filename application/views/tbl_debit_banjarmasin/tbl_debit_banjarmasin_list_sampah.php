    ...
    <section class="content">
            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">SAMPAH DEBIT NOTA BANJARMASIN</h3>
                    </div>
        ...
        <table class="table table-bordered sortable table_wrapper" style="margin-bottom: 10px" id="dataTable">
			...
			<td style="text-align:center" width="300px">
                ...
                //echo '  '; 
                echo anchor(site_url('tbl_debit_banjarmasin/restore_sampah/'.$tbl_debit_banjarmasin->id_debit_banjarmasin),'<i class="fa fa-recycle" aria-hidden="true"></i>','class="btn btn-danger btn-sm"  onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				echo '  '; 
                }
