        ...
        <h4><?php echo $filter ?></h4>
            <table class="table table-bordered sortable"
                ...
                ">
                    ...
                    $totalPPN = 0;
                    $TotalTotal = 0;
                    foreach ($tbl_debit_banjarmasin_data as $tbl):
                    ?>
                    <tr style="display:table; width:100%; table-layout:fixed;">
                        ...
                        <td style="width:120px;text-align:center">
                            <?php
                            if($this->session->userdata('id_user_level') != 7){
                                echo anchor(site_url('tbl_debit_banjarmasin/read/'.$tbl->id_debit_banjarmasin),
                                '<i class="fa fa-print"></i>','class="btn btn-danger btn-sm" target="_blank"');
                                echo ' ';
                                echo anchor(site_url('tbl_debit_banjarmasin/update/'.$tbl->id_debit_banjarmasin),
        ...
        ?>
            ...
            <table class="table table-bordered sortable"
                ...
                ">
                    ...
                    $TotalTotal = 0;
                    $no = 1;
                    foreach ($tbl_payment_banjarmasin_data as $pay):
                    ?>
                    <tr style="display:table; width:100%; table-layout:fixed;">
                        ...
                        <td style="width:120px;text-align:center">
                            ...
                            if($this->session->userdata('id_user_level') != 7){
                                echo anchor(
                                    site_url('tbl_payment_banjarmasin/update/'.$pay->id_payment_banjarmasin),
