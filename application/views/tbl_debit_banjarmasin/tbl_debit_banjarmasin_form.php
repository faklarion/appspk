	...
	<section class="content">
		<div class="box box-warning box-solid">
			<div class="box-header with-border">
				<h3 class="box-title"><?php echo strtoupper($button) ?> DATA DEBIT NOTA BANJARMASIN</h3>
			</div>
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered'>
					...
					<tr>
						<td></td>
						<td>
							<input type="hidden" name="id_debit_banjarmasin" value="<?php echo $id_debit_banjarmasin; ?>" /> 
