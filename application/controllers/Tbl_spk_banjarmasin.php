...
class Tbl_spk_banjarmasin extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            ...
            $config['base_url'] = base_url() . 'index.php/tbl_spk_banjarmasin/index/';
            $config['first_url'] = base_url() . 'index.php/tbl_spk_banjarmasin/index/';
        }

        $config['per_page'] = 10;
        $config['page_query_string'] = FALSE;
        $config['total_rows'] = $this->Tbl_spk_banjarmasin_model->total_rows($q);
        $tbl_spk_banjarmasin = $this->Tbl_spk_banjarmasin_model->get_all();
        $tbl_sub_banjarmasin = $this->Tbl_sub_banjarmasin_model->get_all();
        ...
        $data = array(
            'tbl_spk_banjarmasin_data' => $tbl_spk_banjarmasin,
    ...
    public function delete_sampah($id) 
    {
        ...
        if ($row) {
            $this->Tbl_spk_banjarmasin_model->update($id, $data);
    ...
    public function cari_vendor()
    {
        ...
        $data = array(
            'tbl_spk_banjarmasin_data' => $this->Tbl_spk_banjarmasin_model->get_by_vendor($id_vendor),
            'tbl_vendor_data' => $this->Tbl_vendor_model->get_all(),
            'start' => 0,
            'tbl_vic_data' => $this->Tbl_vic_model->get_all(),
            'pagination' => $this->pagination->create_links(),
    ...
    public function cari_vic()
    {
        ...
        $data = array(
            'tbl_spk_banjarmasin_data' => $this->Tbl_spk_banjarmasin_model->get_by_vic($id_vic),
            'tbl_vendor_data' => $this->Tbl_vendor_model->get_all(),
            'start' => 0,
            'tbl_vic_data' => $this->Tbl_vic_model->get_all(),
            'pagination' => $this->pagination->create_links(),
...
/* End of file Tbl_spk_banjarmasin.php */
/* Location: ./application/controllers/Tbl_spk_banjarmasin.php */
