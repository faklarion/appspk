...
class Tbl_sub_banjarmasin extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            ...
            $config['first_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/index/';
            $config['first_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/index/';
        }
        ...
        $this->template->load('template','tbl_sub_banjarmasin/tbl_sub_banjarmasin_list', $data);
    }
    ...
    public function detail_pekerjaan($id)
    {
        ...
        $config['per_page'] = 10;
        $config['page_query_string'] = FALSE;
        $tbl_pekerjaan_banjarmasin = $this->Tbl_pekerjaan_banjarmasin_model->get_by_id_read($id);
        $config['full_tag_open'] = '<ul class="pagination pagination-sm no-margin pull-right">';
        $config['full_tag_close'] = '</ul>';
        $this->load->library('pagination');
        $this->pagination->initialize($config);
	...
	public function home_vic()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . '.php/c_url/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/home_vic/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/home_vic/';
            $config['first_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/home_vic/';
        }
        ...
        $this->template->load('template','tbl_sub_banjarmasin/tbl_sub_banjarmasin_list_vic', $data);
    }
	...
	public function home_wait()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . '.php/c_url/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/home_wait/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/home_wait/';
            $config['first_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/home_wait/';
        }

        $config['per_page'] = 10;
        $config['page_query_string'] = FALSE;
        $config['total_rows'] = $this->Tbl_sub_banjarmasin_model->total_rows($q);
        $tbl_sub_banjarmasin = $this->Tbl_sub_banjarmasin_model->get_limit_data_wait();
        $config['full_tag_open'] = '<ul class="pagination pagination-sm no-margin pull-right">';
        $config['full_tag_close'] = '</ul>';
        $this->load->library('pagination');
        $this->pagination->initialize($config);
        ...
        $this->template->load('template','approval_banjarmasin_1/banjarmasin_wait', $data);
    }
    ...
    public function wait_kasir()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . '.php/c_url/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/wait_kasir/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/wait_kasir/';
            $config['first_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/wait_kasir/';
        }

        $config['per_page'] = 10;
        $config['page_query_string'] = FALSE;
        $config['total_rows'] = $this->Tbl_sub_banjarmasin_model->total_rows($q);
        $tbl_sub_banjarmasin = $this->Tbl_sub_banjarmasin_model->get_limit_data_wait_kasir();
        $config['full_tag_open'] = '<ul class="pagination pagination-sm no-margin pull-right">';
        $config['full_tag_close'] = '</ul>';
        $this->load->library('pagination');
        $this->pagination->initialize($config);
        ...
        $this->template->load('template','approval_banjarmasin_2/banjarmasin_wait', $data);
    }
	...
	public function home_acc()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . '.php/c_url/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/home_acc/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/home_acc/';
            $config['first_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/home_acc/';
        }

        $config['per_page'] = 10;
        $config['page_query_string'] = FALSE;
        $config['total_rows'] = $this->Tbl_sub_banjarmasin_model->total_rows($q);
        $tbl_sub_banjarmasin = $this->Tbl_sub_banjarmasin_model->get_limit_data_acc();
        $config['full_tag_open'] = '<ul class="pagination pagination-sm no-margin pull-right">';
        $config['full_tag_close'] = '</ul>';
        $this->load->library('pagination');
        $this->pagination->initialize($config);
        ...
        $this->template->load('template','approval_banjarmasin_1/banjarmasin_acc', $data);
    }
    ...
    public function home_acc_kasir()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . '.php/c_url/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/acc_kasir/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/acc_kasir/';
            $config['first_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/acc_kasir/';
        }

        $config['per_page'] = 10;
        $config['page_query_string'] = FALSE;
        $config['total_rows'] = $this->Tbl_sub_banjarmasin_model->total_rows($q);
        $tbl_sub_banjarmasin = $this->Tbl_sub_banjarmasin_model->get_limit_data_acc_kasir($config['per_page'], $start, $q);
        $config['full_tag_open'] = '<ul class="pagination pagination-sm no-margin pull-right">';
        $config['full_tag_close'] = '</ul>';
        $this->load->library('pagination');
        $this->pagination->initialize($config);
        ...
        $this->template->load('template','approval_banjarmasin_2/banjarmasin_acc', $data);
    }
    ...
    public function cari_tanggal_acc_kasir()
    {
        ...
        $tbl_sub_banjarmasin = $this->Tbl_sub_banjarmasin_model->get_data_acc_kasir_tanggal($bulan, $tahun);
        $config['full_tag_open'] = '<ul class="pagination pagination-sm no-margin pull-right">';
        $config['full_tag_close'] = '</ul>';
        $this->load->library('pagination');
        $this->pagination->initialize($config);
	...
	public function home_batal()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . '.php/c_url/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/home_batal/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/home_batal/';
            $config['first_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/home_batal/';
        }

        $config['per_page'] = 10;
        $config['page_query_string'] = FALSE;
        $config['total_rows'] = $this->Tbl_sub_banjarmasin_model->total_rows($q);
        $tbl_sub_banjarmasin = $this->Tbl_sub_banjarmasin_model->get_limit_data_batal();
        $config['full_tag_open'] = '<ul class="pagination pagination-sm no-margin pull-right">';
        $config['full_tag_close'] = '</ul>';
        $this->load->library('pagination');
        $this->pagination->initialize($config);
        ...
        $this->template->load('template','approval_banjarmasin_1/banjarmasin_batal', $data);
    }
    ...
    public function home_batal_kasir()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . '.php/c_url/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/home_batal_kasir/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/home_batal_kasir/';
            $config['first_url'] = base_url() . 'index.php/tbl_sub_banjarmasin/home_batal_kasir/';
        }

        $config['per_page'] = 10;
        $config['page_query_string'] = FALSE;
        $config['total_rows'] = $this->Tbl_sub_banjarmasin_model->total_rows($q);
        $tbl_sub_banjarmasin = $this->Tbl_sub_banjarmasin_model->get_limit_data_batal($config['per_page'], $start, $q);
        $config['full_tag_open'] = '<ul class="pagination pagination-sm no-margin pull-right">';
        $config['full_tag_close'] = '</ul>';
        $this->load->library('pagination');
        $this->pagination->initialize($config);
        ...
        $this->template->load('template','approval_banjarmasin_2/banjarmasin_batal', $data);
    }

    public function read($id) 
    {
        $row = $this->Tbl_sub_banjarmasin_model->get_by_id_read($id);
        if ($row) {
            $data = array(
		...
		'total_payment' => $row->total_payment,
            ...
            $this->template->load('template','tbl_sub_banjarmasin/tbl_sub_banjarmasin_read', $data);
        } else {
    ...
    public function delete_list_kasir($id) 
    {
        ...
        if ($row) {
            ...
            redirect(site_url('tbl_sub_banjarmasin/home_acc_kasir'));
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('tbl_sub_banjarmasin/home_acc_kasir'));
        }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('tbl_sub_banjarmasin/create_action'),
            'spk_data' => $this->Tbl_spk_banjarmasin_model->get_all(),
        ...
        $this->template->load('template','tbl_sub_banjarmasin/tbl_sub_banjarmasin_form', $data);
    }
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
		'id_spk_banjarmasin' => $this->input->post('id_spk_banjarmasin',TRUE),
        ...
        'last_kerja' => "".$this->session->userdata('full_name')." - ".date('Y-m-d H:i:s')."",
            ...
            $this->Tbl_sub_banjarmasin_model->insert($data);
	...
	public function update_pekerjaan($id) 
    {
        ...
        if ($row) {
            $data = array(
                ...
                'action' => site_url('tbl_sub_banjarmasin/update_pekerjaan_action'),
				'id_sub_banjarmasin' => set_value('id_sub_banjarmasin', $row->id_sub_banjarmasin),
	    );
            $this->template->load('template','tbl_sub_banjarmasin/tbl_sub_banjarmasin_pekerjaan', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('tbl_sub_banjarmasin/home_vic'));
        }
    ...
    public function update_pekerjaan_new($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update Pekerjaan',
                'action' => site_url('tbl_sub_banjarmasin/update_pekerjaan_new_action'),
				'id_sub_banjarmasin' => set_value('id_sub_banjarmasin', $row->id_sub_banjarmasin),
            ...
            $this->template->load('template','tbl_sub_banjarmasin/tbl_sub_banjarmasin_pekerjaan_update', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('tbl_spk_banjarmasin'));
        }
    ...
    public function update_pekerjaan_new_action() 
    {
            ...
            $this->Tbl_pekerjaan_banjarmasin_model->insert($data1);
            $this->Tbl_sub_banjarmasin_model->update($this->input->post('id_sub_banjarmasin',TRUE), $data);
            $this->session->set_flashdata('message', 'Create Record Success 2');
            redirect(site_url('tbl_spk_banjarmasin'));
    }
    ...
    {
        $row = $this->Tbl_sub_banjarmasin_model->get_by_id_read_waiting($id);
        $idSub = $row->id_sub_banjarmasin;
        ...
        if ($row) {
            $data = array(
                'button' => 'Approval',
                'action' => site_url('tbl_sub_banjarmasin/acc_action'),
                'id_sub_banjarmasin' => set_value('id_sub_banjarmasin', $row->id_sub_banjarmasin),
            ...
            $this->template->load('template','approval_banjarmasin_1/banjarmasin_acc_form', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('tbl_sub_banjarmasin/home_wait'));
        }
    }
    ...
    public function acc_kasir($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Approval',
                'action' => site_url('tbl_sub_banjarmasin/acc_action_kasir'),
                'id_sub_banjarmasin' => set_value('id_sub_banjarmasin', $row->id_sub_banjarmasin),
                'jumlah_permintaan' => set_value('jumlah_permintaan', $row->jumlah_permintaan),
                'sisa_payment' => set_value('sisa_payment', $sisaBelum),
				'id_waiting_banjarmasin' => set_value('id_waiting_banjarmasin', $row->id_waiting_banjarmasin),
	    );
            $this->template->load('template','approval_banjarmasin_2/banjarmasin_acc_form', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('tbl_sub_banjarmasin/wait_kasir'));
        }
    }
	...
	public function batal($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Pembatalan',
                'action' => site_url('tbl_sub_banjarmasin/batal_action'),
				'id_waiting_banjarmasin' => set_value('id_waiting_banjarmasin', $row->id_waiting_banjarmasin),
	    );
            $this->template->load('template','approval_banjarmasin_1/banjarmasin_batal_form', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('tbl_sub_banjarmasin/home_acc'));
        }
    }
    ...
    public function batal_kasir($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Pembatalan',
                'action' => site_url('tbl_sub_banjarmasin/batal_action_kasir'),
                'id_sub_banjarmasin' => set_value('id_sub_banjarmasin', $row->id_sub_banjarmasin),
                'jumlah_permintaan' => set_value('jumlah_permintaan', $row->jumlah_permintaan),
				'id_waiting_banjarmasin' => set_value('id_waiting_banjarmasin', $row->id_waiting_banjarmasin),
	    );
            $this->template->load('template','approval_banjarmasin_2/banjarmasin_batal_form', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('tbl_sub_banjarmasin/home_acc_kasir'));
        }
    ...
    public function batal_action_kasir() 
    {
        ...
        $data2 = array(
            ...
            $this->Tbl_sub_banjarmasin_model->update($this->input->post('id_sub_banjarmasin', TRUE), $data2);
            $this->session->set_flashdata('message', 'Pembatalan Success');
            redirect(site_url('tbl_sub_banjarmasin/home_acc_kasir'));
    }
    ...
    {
        $row = $this->Tbl_sub_banjarmasin_model->get_by_id($id);

        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('tbl_sub_banjarmasin/update_action'),
		'id_sub_banjarmasin' => set_value('id_sub_banjarmasin', $row->id_sub_banjarmasin),
    ...
    public function update_sub($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('tbl_sub_banjarmasin/update_sub_action'),
		'id_sub_banjarmasin' => set_value('id_sub_banjarmasin', $row->id_sub_banjarmasin),
        'spk_data' => $this->Tbl_spk_banjarmasin_model->get_all(),
		'id_spk_banjarmasin' => set_value('id_spk_banjarmasin', $row->id_spk_banjarmasin),
		'kode_sub' => set_value('kode_sub', $row->kode_sub),
		...
		'last_update' => set_value('last_update', $row->last_update),
            ...
            $this->template->load('template','tbl_sub_banjarmasin/tbl_sub_banjarmasin_form_update', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('tbl_spk_banjarmasin'));
        }
    ...
    public function print_pekerjaan($id) 
    {
        ...
        if ($row) {
            ...
            $this->load->view('tbl_sub_banjarmasin/print_pekerjaan', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('tbl_spk_banjarmasin'));
        }
    ...
    public function tambah_pekerjaan($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update Pekerjaan',
                'action' => site_url('tbl_sub_banjarmasin/tambah_pekerjaan_action'),
		        'id_sub_banjarmasin' => set_value('id_sub_banjarmasin', $row->id_sub_banjarmasin),
	    );
            $this->template->load('template','tbl_sub_banjarmasin/tambah_pekerjaan_form', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('tbl_spk_banjarmasin'));
        }
    ...
    public function update_sub_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->update($this->input->post('id_sub_banjarmasin', TRUE));
        } else {
            $data = array(
                'id_spk_banjarmasin' => $this->input->post('id_spk_banjarmasin',TRUE),
                'kode_sub' => $this->input->post('kode_sub',TRUE),
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Tbl_sub_banjarmasin_model->delete($id);
            $this->session->set_flashdata('message', 'Delete Record Success');
            redirect(site_url('tbl_sub_banjarmasin'));
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
    ...
    public function cetak_kasir($id) 
    {
		...
		'deskripsi' => $row->deskripsi,
            ...
            $this->load->view('tbl_sub_banjarmasin/cetak_payment', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('tbl_sub_banjarmasin/home_acc_kasir'));
        }
    ...
    public function laporan_pekerjaan()
    {
		...
		'total_payment' => $row->total_payment,
            ...
            $this->template->load('template','tbl_sub_banjarmasin/laporan_pekerjaan', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('tbl_sub_banjarmasin'));
        }
    ...
    {
	$this->form_validation->set_rules('id_spk_banjarmasin', 'id spk banjarmasin', 'trim|required');
	...
	$this->form_validation->set_rules('id_sub_banjarmasin', 'id_sub_banjarmasin', 'trim');
    ...
    public function word()
    {
        ...
        header("Content-Disposition: attachment;Filename=tbl_sub_banjarmasin.doc");

        $data = array(
            'tbl_sub_banjarmasin_data' => $this->Tbl_sub_banjarmasin_model->get_all(),
            'start' => 0
        );
        
        $this->load->view('tbl_sub_banjarmasin/tbl_sub_banjarmasin_doc',$data);
    }

    public function lihat_waiting($id)
    {
        $data = array(
            'tbl_waiting_banjarmasin_data' => $this->Tbl_waiting_banjarmasin_model->get_by_id_sub_acc($id),
            'start' => 0
        );
        
        $this->template->load('template','tbl_waiting_banjarmasin/tbl_waiting_banjarmasin_list_detail',$data);
    }
...
/* End of file Tbl_sub_banjarmasin.php */
/* Location: ./application/controllers/Tbl_sub_banjarmasin.php */
